      ...
      /*  protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            if (e.PrelaunchActivated == false)
            {
                ...
                // Register a global back event handler. This can be registered on a per-page-bases if you only have a subset of your pages 85
                // that needs to handle back or if you want to do page-specific logic before deciding to navigate back on those pages.86
